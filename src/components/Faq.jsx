...
import CloseIcon from '../assets/closed-faq.svg';
import OpenIcon from '../assets/open-faq.svg';
          ...
          <div key={index} className="faq-item">
            ...
            >
              ...
              <div className="faq-icon">
                {openIndex === index ? (
                  <img src={CloseIcon} alt="Close" className="faq-icon-close" />
                ) : (
                  <img src={OpenIcon} alt="Close" className="faq-icon-close" />
                )}
              </div>
            </div>
            {openIndex === index && (
